...
const { PRODUCTS, CHECKOUT_ADDRESS } = require('./test-data');
...
test.describe('Re-order', () => {
    ...
    test('places an order, verifies it, then re-orders it', async ({
        catalogPage, cartPage, checkoutPage, ordersPage, orderDetailsPage,
    }) => {
        let orderNumber;
