...
test('Register new account successfully', async ({ page }) => {
    ...
    await action.fillRegisterfields('Cuibap', 'Nguyen', 'dn9@yopmail.com', '1234567890', '1234567890');
    ...
    await action.verifyAccountuser('dn9@yopmail.com');
});
...
test('Register new account with existing email', async ({ page }) => {
    ...
    await action.verifyRegistererrormessage('The specified email already exists');   
});
...
test('Verify required fields', async ({ page }) => {
    ...
    await action.verifyInformationrormessage('First name is required.');
 
    // Verify error message for Last name field
    await action.verifyInformationrormessage('Last name is required.');
 
    // Verify error message for Email field
    await action.verifyInformationrormessage('Email is required.');
 
    // Verify error message for Password field
    await action.verifyInformationrormessage('Password is required.');
 
    // Verify error message for Confirm Password field when passwords do not match
    await action.verifyInformationrormessage('The password and confirmation password do not match.');
    ...
    // Verify error message for Confirm Password field
    await action.verifyInformationrormessage('The password should have at least 6 characters.');
});